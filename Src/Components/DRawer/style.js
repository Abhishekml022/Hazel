...
container:{
    flex: 1, padding: 4, justifyContent: 'space-evenly',backgroundColor:darkmode?Colors.Black:Colors.White
},
container2:{
    alignItems: 'center'
},
...
Nametext:  {fontFamily:'Roboto-Bold',color: darkmode?Colors.White:Colors.Black, textAlign: 'center'},
Emailtext:{
...
//   },
  ...
  PressableText:{color: darkmode?Colors.White:Colors.Black, marginHorizontal: 10},
